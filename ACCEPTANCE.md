# 10-mkdocs-poc -- Acceptance Criteria
...
**Criteria**: `GET /model/projects/10-mkdocs-poc` returns maturity, phase, pbi_total >= 1.
**Verification**:
```powershell
Invoke-RestMethod "http://localhost:8010/model/projects/10-mkdocs-poc" |
...
**Verification**: Run MCP tool `audit_project` with target_path = C:\eva-foundry\10-mkdocs-poc
**Status**: PENDING
...
**Verification**: Run MCP tool `get_trust_score` with repo_path = C:\eva-foundry\10-mkdocs-poc
**Status**: PENDING
...
**Verification**: Run MCP tool `check_encoding` with target_path = C:\eva-foundry\10-mkdocs-poc
**Status**: PENDING
