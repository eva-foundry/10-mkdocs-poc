# 10-mkdocs-poc -- Implementation Status

**Last Updated**: 2026-03-03 by agent:copilot
**Data Model**: GET http://localhost:8010/model/projects/10-mkdocs-poc
...
# Project facts
Invoke-RestMethod "$base/model/projects/10-mkdocs-poc" | Select-Object id, maturity, phase, pbi_total, pbi_done
...
For veritas audit:
```
MCP tool: audit_repo  repo_path=C:\eva-foundry\10-mkdocs-poc
MCP tool: get_trust_score  repo_path=C:\eva-foundry\10-mkdocs-poc
```
...
**Data model record**: http://localhost:8010/model/projects/10-mkdocs-poc
...
1. Run veritas audit: `audit_repo` MCP tool, repo_path = C:\eva-foundry\10-mkdocs-poc
2. Check data model record: GET /model/projects/10-mkdocs-poc
3. Update PLAN.md with actual sprint stories
4. Fill ACCEPTANCE.md gate table with project-specific criteria
5. Commit first evidence: PUT /model/projects/10-mkdocs-poc with updated notes
