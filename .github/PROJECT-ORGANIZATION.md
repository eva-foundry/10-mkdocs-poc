...
<!-- Placeholders: 10-mkdocs-poc = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 10-mkdocs-poc - Organization Standards
