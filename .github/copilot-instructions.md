...
# GitHub Copilot Instructions -- MkDocs POC

**Template Version**: 7.0.0 (Session 71 - project authority contract)  
**Last Updated**: 2026-03-15  
**Project**: MkDocs POC  
**Path**: C:\eva-foundry\10-mkdocs-poc\
...
This file is the **project-level operating contract** for `10-mkdocs-poc`.
...
Invoke-RestMethod "$($session.base)/model/projects/10-mkdocs-poc"
```
...
**Status**: poc  
**Current Phase**: Phase 1 â Hosting Validated  
