...
# [10-mkdocs-poc] Agent Wake-Up Checkpoint
...
## Authoritative Queries
    ...
    $project = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/projects/10-mkdocs-poc"
    $projectWork = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/project_work/?project_id=10-mkdocs-poc"
    $sprints = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/sprints/?project_id=10-mkdocs-poc"
    $evidence = Invoke-RestMethod "https://msub-eva-data-model.victoriousgrass-30debbd3.canadacentral.azurecontainerapps.io/model/evidence/?project_id=10-mkdocs-poc"
